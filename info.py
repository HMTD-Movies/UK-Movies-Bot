...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>🎥 Movie</b>: <a href={url}>{title}</a>\n\n🎭 Genres: {genres}\n\n📆 Year: <a href={url}/releaseinfo>{year}</a>\n\n🌟 Rating: <a href={url}/ratings>{rating}</a> / 10 (based on {votes} user ratings.)\n\n🎙️ Language : <code>{languages}</code>\n\n👥 Cast : <code>{cast}</code>\n\n📀 RunTime: {runtime} Minutes\n\n📆 Release Info : {release_date}🎛 Countries : <code>{countries}</code>\n\n\n\n📢 Update Channel :-\n@UK_Movies_Zone_Updates\n\n🔥 Powered By :-\n@UK_Studios_Official\n@HMTD_Links\n\n🌐 Our Website :- www.HMTDMovies.tk</b>")
